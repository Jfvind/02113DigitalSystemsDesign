...
class GameLogic(SpriteNumber: Int, BackTileNumber: Int, TuneNumber: Int) extends Module {
  ...
  switch(stateReg) {
    ...
    is(autonomousMove) {
      ...
      when(
        sprite17Visible &&
        (sprite14XReg < sprite17XReg + 26.S) && (sprite17XReg < sprite14XReg) &&
        (sprite14YReg < sprite17YReg + 15.S) && (sprite17YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite18Visible &&
        (sprite14XReg < sprite18XReg + 26.S) && (sprite18XReg < sprite14XReg) &&
        (sprite14YReg < sprite18YReg + 15.S) && (sprite18YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite19Visible &&
        (sprite14XReg < sprite19XReg + 26.S) && (sprite19XReg < sprite14XReg) &&
        (sprite14YReg < sprite19YReg + 15.S) && (sprite19YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite20Visible &&
        (sprite14XReg < sprite20XReg + 26.S) && (sprite20XReg < sprite14XReg) &&
        (sprite14YReg < sprite20YReg + 15.S) && (sprite20YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite21Visible &&
        (sprite14XReg < sprite21XReg + 26.S) && (sprite21XReg < sprite14XReg) &&
        (sprite14YReg < sprite21YReg + 15.S) && (sprite21YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite22Visible &&
        (sprite14XReg < sprite22XReg + 26.S) && (sprite22XReg < sprite14XReg) &&
        (sprite14YReg < sprite22YReg + 15.S) && (sprite22YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite23Visible &&
        (sprite14XReg < sprite23XReg + 26.S) && (sprite23XReg < sprite14XReg) &&
        (sprite14YReg < sprite23YReg + 15.S) && (sprite23YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite24Visible &&
        (sprite14XReg < sprite24XReg + 26.S) && (sprite24XReg < sprite14XReg) &&
        (sprite14YReg < sprite24YReg + 15.S) && (sprite24YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite25Visible &&
        (sprite14XReg < sprite25XReg + 26.S) && (sprite25XReg < sprite14XReg) &&
        (sprite14YReg < sprite25YReg + 15.S) && (sprite25YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite26Visible &&
        (sprite14XReg < sprite26XReg + 29.S) && (sprite26XReg < sprite14XReg) &&
        (sprite14YReg < sprite26YReg + 15.S) && (sprite26YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite27Visible &&
        (sprite14XReg < sprite27XReg + 29.S) && (sprite27XReg < sprite14XReg) &&
        (sprite14YReg < sprite27YReg + 15.S) && (sprite27YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite28Visible &&
        (sprite14XReg < sprite28XReg + 29.S) && (sprite28XReg < sprite14XReg) &&
        (sprite14YReg < sprite28YReg + 15.S) && (sprite28YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite29Visible &&
        (sprite14XReg < sprite29XReg + 29.S) && (sprite29XReg < sprite14XReg) &&
        (sprite14YReg < sprite29YReg + 15.S) && (sprite29YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite30Visible &&
        (sprite14XReg < sprite30XReg + 29.S) && (sprite30XReg < sprite14XReg) &&
        (sprite14YReg < sprite30YReg + 15.S) && (sprite30YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite31Visible &&
        (sprite14XReg < sprite31XReg + 29.S) && (sprite31XReg < sprite14XReg) &&
        (sprite14YReg < sprite31YReg + 15.S) && (sprite31YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite32Visible &&
        (sprite14XReg < sprite32XReg + 29.S) && (sprite32XReg < sprite14XReg) &&
        (sprite14YReg < sprite32YReg + 15.S) && (sprite32YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite33Visible &&
        (sprite14XReg < sprite33XReg + 29.S) && (sprite33XReg < sprite14XReg) &&
        (sprite14YReg < sprite33YReg + 15.S) && (sprite33YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite34Visible &&
        (sprite14XReg < sprite34XReg + 29.S) && (sprite34XReg < sprite14XReg) &&
        (sprite14YReg < sprite34YReg + 15.S) && (sprite34YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite35Visible &&
        (sprite14XReg < sprite35XReg + 29.S) && (sprite35XReg < sprite14XReg) &&
        (sprite14YReg < sprite35YReg + 15.S) && (sprite35YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite36Visible &&
        (sprite14XReg < sprite36XReg + 32.S) && (sprite36XReg < sprite14XReg) &&
        (sprite14YReg < sprite36YReg + 15.S) && (sprite36YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite37Visible &&
        (sprite14XReg < sprite37XReg + 32.S) && (sprite37XReg < sprite14XReg) &&
        (sprite14YReg < sprite37YReg + 15.S) && (sprite37YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite38Visible &&
        (sprite14XReg < sprite38XReg + 32.S) && (sprite38XReg < sprite14XReg) &&
        (sprite14YReg < sprite38YReg + 15.S) && (sprite38YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite39Visible &&
        (sprite14XReg < sprite39XReg + 32.S) && (sprite39XReg < sprite14XReg) &&
        (sprite14YReg < sprite39YReg + 15.S) && (sprite39YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite40Visible &&
        (sprite14XReg < sprite40XReg + 32.S) && (sprite40XReg < sprite14XReg) &&
        (sprite14YReg < sprite40YReg + 15.S) && (sprite40YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite41Visible &&
        (sprite14XReg < sprite41XReg + 32.S) && (sprite41XReg < sprite14XReg) &&
        (sprite14YReg < sprite41YReg + 15.S) && (sprite41YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite42Visible &&
        (sprite14XReg < sprite42XReg + 32.S) && (sprite42XReg < sprite14XReg) &&
        (sprite14YReg < sprite42YReg + 15.S) && (sprite42YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite43Visible &&
        (sprite14XReg < sprite43XReg + 32.S) && (sprite43XReg < sprite14XReg) &&
        (sprite14YReg < sprite43YReg + 15.S) && (sprite43YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite44Visible &&
        (sprite14XReg < sprite44XReg + 32.S) && (sprite44XReg < sprite14XReg) &&
        (sprite14YReg < sprite44YReg + 15.S) && (sprite44YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
      when(
        sprite45Visible &&
        (sprite14XReg < sprite45XReg + 32.S) && (sprite45XReg < sprite14XReg) &&
        (sprite14YReg < sprite45YReg + 15.S) && (sprite45YReg < sprite14YReg + 8.S)
      ) {
        collisionDetected := true.B
      }
